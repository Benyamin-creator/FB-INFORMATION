...
def baliho():
	try:
		...
		runntek("				")
		time.sleep(1)
		runntek("" +G+ "              https://github.com/Benyamin-creator/FB-INFORMATION\n")
		time.sleep(1)
		...
		print ("	       _ _                        /                          ( \> > \ ").center(44)
		print ("	   -/~/ / ~\                     :;                \       _  > /(~\/ ").center(44)
		print ("	  || | | /\ ;\                   |l      _____     |;     ( \/    > > ").center(44)
		print ("	  _\\)\)\)/ ;;;                  `8o __-~     ~\   d|      \      // ").center(44)
		print ("	 ///(())(__/~;;\                   88p;.  -. _\_;.oP        (_._/ / ").center(44)
		print ("	(((__   __ \\   \                  `>,% (\  (\./)8          ;:'  i ").center(44)
		print ("	)))--`.'-- (( ;,8 \               ,;%%%:  ./V^^^V*          ;.   ;. ").center(44)
		print ("	((\   |   /)) .,88  `: ..,,;;;;,-::::::'_::\   ||\         ;[8:   ; ").center(44)
		print ("	 )|  ~-~  |(|(888; ..``'::::8888oooooo.  :\`^^^/,,~--._    |88::  | ").center(44)
		print ("	 |\ -===- /|  \8;; ``:.      oo.8888888888:`((( o.ooo8888Oo;:;:'  | ").center(44)
		print ("	 |_~-___-~_|   `-\.   `        `o`88888888b` )) 888b88888P**'     ; ").center(44)
		print ("	 ; ~~~~;~~          `--_`.       b`888888888;(.,*888b888*  ..::;-' ").center(44)
		print ("	   ;      ;              ~*-....  b`8888888:::::.`8888. .:;;;** ").center(44)
		print ("	      ;    ;                 `:::. `:::OOO:::::::.`OO' ;;;** ").center(44)
		print ("	 :       ;                     `.      *``::::::**    .' ").center(44)
		print ("	    ;                           `.   \_              / ").center(44)
		print ("	  ;       ;                       +:   ~~--  `:'  -*; ").center(44)
		print ("	                                   `:         : .::/ ").center(44)
		...
		print (N + '     					  [' + G +'Facebook Information'+ N + ']')
		time.sleep(1)
		print ("")
####################################################################
#		    Print In terminal
...
def like(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			try:
				print '\r' + N + '[' + G + id + N + '] ' + post['message'][:40].replace('\n',' ') + '...'
			except KeyError:
				try:
					print '\r' + B + '[' + G + id + B + '] ' + post['story'].replace('\n',' ')
				except KeyError:
					print '\r' + N + '[' + G + id + N + '] Successfully liked'
...
def comment(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			try:
				print N + '[' + G + id + N + '] ' +post['message'][:40].replace('\n',' ') + '...'
			except KeyError:
				try:
					print N + '[' + G + id + N + '] ' + post['story'].replace('\n',' ')
				except KeyError:
					print N + '[' + G + id + N + '] successfully commented'
		print '[*] Done'
		bot()
	except KeyboardInterrupt:
                print '\r[!] Stopped'
...
def remove(posts):
	...
	try:
		...
		for post in posts:
			...
			try:
				cek = a['error']['message']
				print N + '[' + R + post['id'] + N +'] Failed'
			except TypeError:
				print N + '[' + G + post['id'] + N + '] Removed'
				counter += 1
		print '[*] done'
		bot()
	except KeyboardInterrupt:
...
def confirm(posts):
	...
	try:
		...
		for post in posts:
			...
			try:
				cek = a['error']['message']
				print N + '[' + R + post['from']['name'] + N + '] Failed'
			except TypeError:
				print N + '[' + G + post['from']['name'] + N + '] Confirmed'
		print '[*] Done'
		bot()
	except KeyboardInterrupt:
		print '\r[!] Stopped'
...
def unfollow(posts):
	...
	try:
		...
		for post in posts['data']:
			...
			try:
				cek = a['error']['nessage']
				print N + '[' + R + post['name'] + N + '] failed'
			except TypeError:
				print N + '[' + G + post['name'] + N + '] unfollow'
		print '[*] done'
		bot()
	except KeyboardInterrupt:
		print '\r[!] Stopped'
...
def poke(posts):
	...
	try:
		...
		for post in posts:
			...
			try:
				cek = a['error']['message']
				print N + '[' + R + id + N + '] failed'
			except TypeError:
				print N + '[' + G + id + N + '] pokes'
		print '[*] Done'
		bot()
	except KeyboardInterrupt:
		print '\r[!] Stopped   '
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'BENYAMIN' + N + '/' + R + 'Bot' + N + '/' + R + 'Reaction' + N + ' >> ')
...
def bot_ask():
	...
	WT = raw_input(W + '[?] [' + R + 'W' + N + ']allpost or [' + R + 'T' + N + ']arget (' + R + 'W' + N + '/' + R + 'T' + N + ') : ')
	if WT.upper() == 'T':
...
def bot():
  try:
	...
	cek = raw_input(R + 'BENYAMIN' + N +'/' + R +'Bot ' + N + '>> ')
	...
	try:
		...
		for i in a['data']:
			...
			try:
				...
				print N + '[' + G + z['name'] + N + ']' + R + ' >> ' + N + z['mobile_phone']
			except KeyError:
				pass
		out.close()
		print '[*] done'
...
def dump_mail():
	...
	try:
		...
		for i in a['data']:
			...
			try:
                                out.write(z['email'] + '\n')
			        print N + '[' + G + z['name'] + N + ']' + R + ' >> ' + N + z['email']
			except KeyError:
				pass
		out.close()
...
def main():
  ...
  try:
	cek = raw_input(B + 'BENYAMIN-CREATOR' + N +' >> ')
